...
import bg.technologies.carshop.service.impl.CarShopUserDetailsService;
import bg.technologies.carshop.service.oauth.OAuthSuccessHandler;
...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(
            @Value("${carshop.remember.me.key}") String rememberMeKey) {
